    ...
    return (
        ...
        <Navbar bg="light" variant="light" className='navbar'>
            ...
            <Container style={{ "height": "55px" }}>
                ...
                <Navbar.Brand style={{ "fontSize": "38px", "fontWeight": "bold", color: "rgba(245, 40, 145, 0.8)", marginTop:"-1%" }} onClick={() => {navigate("/")}}>
                <svg viewBox="0 0 87 20" fill="none" xmlns="http://www.w3.org/2000/svg" width="156" height="36" iconSize="20" class="Icon-sc-1iwi4w1-0 cZPTbN" className='svg-brand'>
                        <path
                ...
                <input id='search-input' type="search" placeholder='Try Saree, Kurti or search by Product code' style={{ "width": "30%", "padding": "15px", "marginRight": "23%",marginLeft: "1%", "borderRadius": "5px", "borderColor": "lightGrey" }}></input>
                <Nav className="me-auto">
                    <Nav.Link>
                        <div style={{ "marginRight": "1%", marginLeft: "-0%" }}>

                            <i class="fa-light fa-mobile" style={{ "color": "black", "paddingTop": "25px", "marginLeft": "-5.5rem", "display": "flex" }}></i>
                            <p className='dropdown'>Download App
                    ...
                    <Nav.Link>
                        ...
                        <i class="fa-solid fa-user" style={{ "paddingTop": "20px", "marginRight": "1.9rem", "marginLeft": "2rem", "fontSize": "20px" }} onClick={() => {navigate("/Signup")}}>
                            ...
                            <div className='hover_dropdown_two'>
                                ...
                                <button className='hover_btn' onClick={() => {navigate("/Signup")}}>Sign Up</button>
