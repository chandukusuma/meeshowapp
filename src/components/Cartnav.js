...
function Cartnav() {
    ...
    return (
        <div>
            <nav class="navbar fixed-top navbar-light bg-light" className='fixed-nav'>
                <div class="container-fluid" className='container-1'>
